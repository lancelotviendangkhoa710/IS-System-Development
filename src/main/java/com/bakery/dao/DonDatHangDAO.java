...
public class DonDatHangDAO {
    ...
    public int taoDonHang(DonDatHangDTO donDatHang, List<CTDonHangDTO> dsCtDonHang, List<CTDonTuyChinhDTO> dsCtTuyChinh)
        ...
        try (Connection conn = DBConnect.getConnection()) {
            ...
            try (CallableStatement cstmt = conn.prepareCall(sql)) {
                ...
                cstmt.setString(8, buildJsonChiTiet(dsCtDonHang, dsCtTuyChinh));
                cstmt.registerOutParameter(9, Types.NUMERIC);
                cstmt.execute();

                int maDonMoi = cstmt.getInt(9);
                System.out.println("[DB] Tao don hang thanh cong. MADON = " + maDonMoi);
                return maDonMoi;
            }
        } catch (SQLException e) {
            System.err.println("Loi DAO - taoDonHang: " + e.getMessage());
            throw e;
        }
    }
    ...
    public void chuyenTrangThaiDon(int maDon, int maTrangThaiMoi, int maNvCapNhat, Integer hinhThucNhan)
        ...
        try (Connection conn = DBConnect.getConnection()) {
            ...
            System.err.println("Loi DAO - chuyenTrangThaiDon: " + e.getMessage());
            throw e;
        }
    }
    ...
    public void huyDonVaHoanKho(int maDon, String lyDoHuy, int maNvCapNhat) throws SQLException {
        ...
        try (Connection conn = DBConnect.getConnection()) {
            ...
            System.err.println("Loi DAO - huyDonVaHoanKho: " + e.getMessage());
            throw e;
        }
    }
    ...
    public boolean tonTaiDonHang(int maDon) throws SQLException {
        ...
        try (Connection conn = DBConnect.getConnection()) {
            ...
            System.err.println("Loi DAO - tonTaiDonHang: " + e.getMessage());
            throw e;
        }
    ...
    public String layTenTrangThaiDon(int maDon) throws SQLException {
        String sql = "SELECT TT.TENTRANGTHAI " +
                "FROM DONDATHANG DDH " +
        ...
        try (Connection conn = DBConnect.getConnection()) {
            ...
            System.err.println("Loi DAO - layTenTrangThaiDon: " + e.getMessage());
            throw e;
        }
    ...
    public DonDatHangDTO layTomTatDonHang(int maDon) throws SQLException {
        String sql = "SELECT MADON, MAKH, MATRANGTHAI, TONGTIENHDBAN " +
                "FROM DONDATHANG " +
                "WHERE MADON = ?";
        ...
        try (Connection conn = DBConnect.getConnection()) {
            ...
            System.err.println("Loi DAO - layTomTatDonHang: " + e.getMessage());
            throw e;
        }
    ...
    public List<TrangThaiDonDTO> layDanhSachTrangThaiDon() throws SQLException {
        ...
        try (Connection conn = DBConnect.getConnection()) {
            ...
            System.err.println("Loi DAO - layDanhSachTrangThaiDon: " + e.getMessage());
            throw e;
        }
    ...
    private String buildJsonChiTiet(List<CTDonHangDTO> dsCtDonHang, List<CTDonTuyChinhDTO> dsCtTuyChinh) {
        ...
        if (dsCtTuyChinh != null) {
            for (CTDonTuyChinhDTO item : dsCtTuyChinh) {
                ...
                json.append("{")
                        ...
                        .append("\"ghiChu\":\"").append(escapeJsonText(item.getLoiChucTrenBanh())).append("\",")
                        .append("\"phuKien\":\"").append(escapeJsonText(item.getGhiChuThoBanh())).append("\"")
                        .append("}");
            }
        }

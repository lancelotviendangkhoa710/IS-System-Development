...
public class HoatDongNhanVienDTO {
    ...
    public HoatDongNhanVienDTO(int maHoatDong, int maNV, String tenNhanVien,
            String vaitro, String nhom, String hanhDong,
    ...
    public void setTenNhanVien(String v) {
        this.tenNhanVien = v;
    }
    ...
    public void setNhom(String v) {
        this.nhom = v;
    }

    public void setHanhDong(String v) {
        this.hanhDong = v;
    }
    ...
    public void setThoiGian(LocalDateTime v) {
        this.thoiGian = v;
    }
}

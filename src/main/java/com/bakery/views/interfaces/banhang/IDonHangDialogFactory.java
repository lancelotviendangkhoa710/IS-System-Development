 ...
 */
public interface IDonHangDialogFactory {

    /** 
     * Record chứa thông tin kết quả từ wizard "Tạo Đơn Hàng".
     */
    record YeuCauDonHang(
            ...
            // Loại đơn
            LoaiDonHang orderType,    // IMMEDIATE (Giao ngay) hoặc PREORDER (Đặt trước)
        ...
        public static YeuCauDonHang cancelled() {
            return new YeuCauDonHang(false, null, "Khách vãng lai", "", null,
                    null, 0, null, "", 0);
        }
    }
    ...
    record YeuCauHuyDonHang(
        ...
        public static YeuCauHuyDonHang cancelled() {
            return new YeuCauHuyDonHang(false, "", 0);
        }
    }
     ...
     */
    YeuCauDonHang showCreateOrderDialog(double tongTienPhaiTra, TraCuuKhachHang customerLookup);
     ...
     */
    YeuCauHuyDonHang showCancelOrderDialog(int maDon, double depositAmount);
}

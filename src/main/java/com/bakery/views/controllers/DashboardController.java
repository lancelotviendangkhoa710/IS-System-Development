...
import com.bakery.presenters.DashboardPresenter;
...
public class DashboardController implements IDashboardView {
    ...
    private final DashboardPresenter presenter = new DashboardPresenter(this, new DashboardService());
    ...
    @Override
    public void hienThiKPI(DashboardKPIDTO kpi) {
        Platform.runLater(() -> {
    ...
    public void hienThiDialogDongCa() {
        Platform.runLater(DoiSoatDongCaController::hienThi);
    }

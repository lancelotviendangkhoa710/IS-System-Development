...
public class NhanSuViewFXMLController extends BaseController {
    ...
    @FXML
    private Tab tabPhanQuyen;
    @FXML
    private Tab tabVaiTro;
    @FXML
    private StackPane stackNhanVien;
    @FXML
    private StackPane stackPhanQuyen;
    @FXML
    private StackPane stackVaiTro;
    ...
    private void taiTabNhanVien() {
        ...
        if (view != null)
            stackNhanVien.getChildren().setAll(view);
    }
    ...
    private void taiTabPhanQuyen() {
        ...
        if (view != null)
            stackPhanQuyen.getChildren().setAll(view);
    }
    ...
    private void taiTabVaiTro() {
        ...
        if (view != null)
            stackVaiTro.getChildren().setAll(view);
    }

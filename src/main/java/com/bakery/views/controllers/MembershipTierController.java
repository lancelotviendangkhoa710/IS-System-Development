...
import com.bakery.presenters.CustomerTierPresenter;
import com.bakery.views.interfaces.MembershipTierView;
...
public class MembershipTierController implements MembershipTierView {
    ...
    private void setupColumns() {
        ...
        colPhanTramGiamGia.setCellValueFactory(cd -> new javafx.beans.property.SimpleDoubleProperty(cd.getValue().getPhanTramGiamGia()).asObject());
    ...
    private void openEditTierDialog(HangThanhVienDTO tier) {
        ...
        dialog.showAndWait().ifPresent(t -> {
            try {
                ...
                t.setPhanTramGiamGia(Double.parseDouble(txtDiscount.getText().trim()));

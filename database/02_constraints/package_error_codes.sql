...
CREATE OR REPLACE PACKAGE PKG_ERROR_CODES AS
    ...
    -- Me san xuat / Han su dung thanh pham
    ERR_TINHHSD_MESANXUAT           CONSTANT NUMBER := -20323;
    ERR_BANH_HETHAN                 CONSTANT NUMBER := -20324;
    ERR_XUAT_THANHPHAM_HETHAN       CONSTANT NUMBER := -20325;
    ...
    ERR_TRANG_THAI_KHONG_HOP_LE     CONSTANT NUMBER := -20521;

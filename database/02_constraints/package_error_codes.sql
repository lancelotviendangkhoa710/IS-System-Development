...
CREATE OR REPLACE PACKAGE PKG_ERROR_CODES AS
    ...
    ERR_HOAN_XUAT_BANH              CONSTANT NUMBER := -20204;
    ERR_DM_THEM_HE_THONG            CONSTANT NUMBER := -20205;
    ERR_DM_KHONG_TON_TAI_CN         CONSTANT NUMBER := -20206;
    ERR_DM_CAPNHAT_HE_THONG         CONSTANT NUMBER := -20207;
    ERR_DM_KHONG_TON_TAI_XOA        CONSTANT NUMBER := -20208;
    ERR_DM_XOA_HE_THONG             CONSTANT NUMBER := -20209;
    --Sản phẩm
    ERR_SANPHAM_THEM_HE_THONG       CONSTANT NUMBER := -20210;
    ERR_SANPHAM_KHONG_TON_TAI_CN    CONSTANT NUMBER := -20211;
    ERR_SANPHAM_CAPNHAT_HE_THONG    CONSTANT NUMBER := -20212;
    ERR_SANPHAM_KHONG_TON_TAI_XOA   CONSTANT NUMBER := -20213;
    ERR_SANPHAM_XOA_HE_THONG        CONSTANT NUMBER := -20214;
    --Kích cỡ bánh
    ERR_KICHCO_THEM_HE_THONG        CONSTANT NUMBER := -20215;
    ERR_KICHCO_KHONG_TON_TAI_CN     CONSTANT NUMBER := -20216;
    ERR_KICHCO_CAPNHAT_HE_THONG     CONSTANT NUMBER := -20217;
    ERR_KICHCO_KHONG_TON_TAI_XOA    CONSTANT NUMBER := -20218;
    ERR_KICHCO_XOA_HE_THONG         CONSTANT NUMBER := -20219;
    --Cốt bánh
    ERR_COTBANH_THEM_HE_THONG       CONSTANT NUMBER := -20220;
    ERR_COTBANH_KHONG_TON_TAI_CN    CONSTANT NUMBER := -20221;
    ERR_COTBANH_CAPNHAT_HE_THONG    CONSTANT NUMBER := -20222;
    ERR_COTBANH_KHONG_TON_TAI_XOA   CONSTANT NUMBER := -20223;
    ERR_COTBANH_XOA_HE_THONG        CONSTANT NUMBER := -20224;
    --Nhân bánh
    ERR_NHANBANH_THEM_HE_THONG      CONSTANT NUMBER := -20225;
    ERR_NHANBANH_KHONG_TON_TAI_CN   CONSTANT NUMBER := -20226;
    ERR_NHANBANH_CAPNHAT_HE_THONG   CONSTANT NUMBER := -20227;
    ERR_NHANBANH_KHONG_TON_TAI_XOA  CONSTANT NUMBER := -20228;
    ERR_NHANBANH_XOA_HE_THONG       CONSTANT NUMBER := -20229;
    -- Trang trí
    ERR_TRANGTRI_THEM_HE_THONG      CONSTANT NUMBER := -20230;
    ERR_TRANGTRI_KHONG_TON_TAI_CN   CONSTANT NUMBER := -20231;
    ERR_TRANGTRI_CAPNHAT_HE_THONG   CONSTANT NUMBER := -20232;
    ERR_TRANGTRI_KHONG_TON_TAI_XOA  CONSTANT NUMBER := -20233;
    ERR_TRANGTRI_XOA_HE_THONG       CONSTANT NUMBER := -20234;
    ...
    ERR_NL_TON_AO                   CONSTANT NUMBER := -20310;

    --Lỗi thêm mới nguyên liệu
    ERR_NL_THEM_MOI                 CONSTANT NUMBER := -20311;

    --Lỗi update  nguyên liệu
    ERR_NL_CAPNHAT_HE_THONG         CONSTANT NUMBER := -20312;

    --Lỗi xóa nguyên liệu
    ERR_NL_XOA_HE_THONG             CONSTANT NUMBER := -20313;

    -- Lỗi hệ thống khi nhập kho vật tư
    ERR_PHIEU_NHAP_KHO              CONSTANT NUMBER := -20314;

    -- Lỗi hệ thống khi hủy phiếu nhập kho
    ERR_HOAN_PHIEU_NHAP_KHO         CONSTANT NUMBER := -20315;
    ...
    -- NHÓM 05: TÀI CHÍNH
    -- ========================
    -- Vi phạm kế toán: cấm xóa vật lý hóa đơn
    ERR_TC_CAM_XOA_HOADON           CONSTANT NUMBER := -20501;
    -- Vi phạm kế toán: cấm xóa vật lý phiếu thu chi
    ERR_TC_CAM_XOA_PHIEUTHUCHI      CONSTANT NUMBER := -20502;

    -- Phương thức thanh toán
    ERR_PTTT_THEM_HE_THONG          CONSTANT NUMBER := -20503;
    ERR_PTTT_KHONG_TON_TAI_CN       CONSTANT NUMBER := -20504;
    ERR_PTTT_CAPNHAT_HE_THONG       CONSTANT NUMBER := -20505;
    ERR_PTTT_KHONG_TON_TAI_XOA      CONSTANT NUMBER := -20506;
    ERR_PTTT_XOA_HE_THONG           CONSTANT NUMBER := -20507;

    -- Loại thu chi
    ERR_LOAITHUCHI_THEM_HE_THONG        CONSTANT NUMBER := -20508;
    ERR_LOAITHUCHI_KHONG_TON_TAI_CN     CONSTANT NUMBER := -20509;
    ERR_LOAITHUCHI_CAPNHAT_HE_THONG     CONSTANT NUMBER := -20510;
    ERR_LOAITHUCHI_KHONG_TON_TAI_XOA    CONSTANT NUMBER := -20511;
    ERR_LOAITHUCHI_XOA_HE_THONG         CONSTANT NUMBER := -20512;

    -- Lỗi hệ thống khi tạo phiếu thu chi
    ERR_PHIEUTHUCHI_THEM_HE_THONG       CONSTANT NUMBER := -20513;
    -- Lỗi hệ thống khi tạo hóa đơn
    ERR_HOADON_THEM_HE_THONG            CONSTANT NUMBER := -20514;

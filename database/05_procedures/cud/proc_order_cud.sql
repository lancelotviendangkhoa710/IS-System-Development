...
IS
    V_TONGTIEN NUMBER(15,2) := 0;
BEGIN
    -- 0. Tính toán tổng tiền trước để tránh vi phạm Check Constraint (TONGTIEN >= TIENDACOC)
    ...
    -- 1. Insert Đơn Hàng Gốc (Đã kèm TONGTIENHDBAN)
